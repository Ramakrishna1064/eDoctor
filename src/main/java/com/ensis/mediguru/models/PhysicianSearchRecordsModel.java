 ...
 *
 */
public class PhysicianSearchRecordsModel {
	...
	private boolean isFavoritePhysician;
	private boolean isFamilyPhysician;
	private boolean isOngoingPhysician;
	private double rating;
	
	private ArrayList<PhysicianCommentsModel> reviews=new ArrayList<PhysicianCommentsModel>();

	public ArrayList<PhysicianCommentsModel> getReviews() {
		return reviews;
	}

	public void setReviews(ArrayList<PhysicianCommentsModel> reviews) {
